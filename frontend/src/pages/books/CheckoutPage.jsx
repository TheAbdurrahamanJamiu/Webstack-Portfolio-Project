...
const CheckoutPage = () => {
    ...
    const [isChecked, setIsChecked] = useState(false); // This will control the checkbox state
    ...
    const onSubmit = async (data) => {
        ...
        try {
            await createOrder(newOrder).unwrap(); // Use unwrap() to handle success/failure
            Swal.fire({
                title: "Confirmed Order",
                text: "Order placed successfully!",
                icon: "success", // Changed to 'success' for positive feedback
                confirmButtonColor: "#3085d6",
                confirmButtonText: "OK"
            }).then(() => {
                navigate("/"); // Redirect to the homepage after order is placed
            });
        } catch (error) {
                                    ...
                                    <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">
                                        ...
                                        <div className="md:col-span-3">
                                            ...
                                            <input
                                                ...
                                                type="text" name="address" id="address" className="h-10 border mt-1 rounded px-4 w-full bg-gray-50" />
                                        </div>
